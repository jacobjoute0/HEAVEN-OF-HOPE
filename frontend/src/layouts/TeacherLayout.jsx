...
const teacherLinks = [
  ...
  { name: 'Upload Marks',  path: '/teacher/marks',         icon: '📊' },
...
export default function TeacherLayout() {
  return (
    <div className="flex min-h-screen bg-green-50">
      <Sidebar links={teacherLinks} title="Teacher Portal" />
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-green-100 px-6 py-3 flex items-center justify-between sticky top-0 z-30 shadow-sm">
          <h1 className="text-green-800 font-bold text-lg">Teacher Portal</h1>
