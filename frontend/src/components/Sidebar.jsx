    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-green-700 flex items-center gap-3">
        ...
        <div className="w-10 h-10 flex-shrink-0">
          <img
            src={logo}
            alt="Haven of Hope Logo"
            className="w-full h-full object-contain rounded-full border-2 border-green-300 bg-white"
          />
        </div>
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              <p className="font-bold text-sm leading-tight text-white whitespace-nowrap">
                Haven of Hope
              </p>
