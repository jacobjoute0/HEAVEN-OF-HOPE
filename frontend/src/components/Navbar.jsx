...
/>
            ...
            <div className="sm:block">
              <p className="font-bold italic text-lg leading-tight">Haven of Hope Academy</p>
              <p className="text-green-300 italic text-xs italic">Learning Today, Leading Tomorrow</p>
            </div>
          </Link>
